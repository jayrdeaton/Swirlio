...
export {
  ...
  DEFAULT_BOUNCE_FRICTION,
  DEFAULT_DASH_STYLE,
  DEFAULT_FIXED_SPACING,
  DEFAULT_FOREGROUND_COLORS,
  DEFAULT_GRAVITY,
  DEFAULT_MIRROR_ALTERNATE_COLORS,
  DEFAULT_MIRROR_GAP,
  DEFAULT_MIRROR_LINES,
  DEFAULT_MIRROR_ROTATION_SPEED,
  DEFAULT_PARTICLE_BORDER_COLORS,
  DEFAULT_PARTICLE_BORDER_WIDTH,
  DEFAULT_PARTICLE_COLORS,
  DEFAULT_PARTICLE_COUNT,
  DEFAULT_PARTICLE_SHAPES,
  ...
  MAX_MIC_SENSITIVITY,
  MAX_MIRROR_GAP,
  MAX_MIRROR_ROTATION_SPEED,
  MAX_PARTICLE_BORDER_WIDTH,
  MAX_PARTICLE_COUNT,
  MAX_PARTICLE_SIZE,
  MAX_POLYGON_SIDES,
  MAX_ROTATION_SPEED,
